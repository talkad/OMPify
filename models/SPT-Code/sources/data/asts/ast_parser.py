...
LANGUAGE = {enums.LANG_GO: Language('data/asts/build/my-languages.so', 'go'),
            ...
            enums.LANG_CPP: Language('data/asts/build/my-languages.so', 'cpp')}
...
STATEMENT_ENDING_STRINGS = {
    ...
    enums.LANG_C: ['statement', 'expression', 'declaration'],
    enums.LANG_CPP: ['statement', 'expression', 'declaration'],
}
