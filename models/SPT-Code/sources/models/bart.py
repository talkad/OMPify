...
class BartForClassificationAndGeneration(BartForConditionalGeneration):
    ...
    def forward_cls(
        ...
        for tens in input_ids:
            tens = tens.roll(1)
            tens[0] = 1 

            for idx, i in enumerate(tens):
                if i == 0:
                    break

            tens[idx] = 2
            updated_torch.append(tens)

        # print(input_ids[0])
        # print(updated_torch[0])

        input_ids = torch.stack(updated_torch)
        # print(input_ids[0])
        ...
        # print(eos_mask[0])
        # print('c'*10)
        # print(hidden_states[eos_mask, :][0])
