...
class RuntimeArguments:
    ...
    trained_vocab: str = field(
        default='/home/talkad/LIGHTBITS_SHARE/pre_trained/vocabs/',
        metadata={'help': 'Directory of trained vocabs'}
    )

    trained_model: str = field(
        default='/home/talkad/LIGHTBITS_SHARE/pre_trained/models/all/',
...
class DatasetArguments:
    ...
    dataset_root: str = field(
        default='/home/talkad/LIGHTBITS_SHARE/dataset/', #'../../dataset/',
