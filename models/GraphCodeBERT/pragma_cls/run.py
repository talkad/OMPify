...
def convert_examples_to_features(item, update_ratio):
    ...
    _, label, path, tokenizer, args=item
    ...
    def __init__(self, tokenizer, args, file_path='train', update_ratio=0):
        ...
        with open(index_filename, 'r') as f:
            for idx, line in enumerate(f):
                ...
                data.append((js['code'], js['reduction'], js['path'], tokenizer, args))
        ...
        for step, batch in enumerate(bar):
            ...
            if (step + 1) % args.gradient_accumulation_steps == 0:
                ...
                if global_step % args.save_steps == 0:
                    results = evaluate(args, model, eval_dataloader, tokenizer, eval_when_training=True)    
