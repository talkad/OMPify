...
#define svc_frametime		54		// GAJA: read float for the new server frametime
#define svc_spawnspotinfo	55		// GAJA: message to the client with a spawn spot number 
...
#define	MAX_PACKET_ENTITIES	128	// doesn't count nails
typedef struct
{
	int		num_entities;
