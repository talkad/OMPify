...
//===== NETWORK ============
	...
	// GAJA: add an omp lock for each client
	DECLARE_LOCK(msg_lock)
	int				clientId;			// GAJA: assign a unique ID using the possition in the client array
										// used for locking. The field userid is not good for us.
} client_t;
...
// GAJA: made threadprivate
// extern	client_t	*host_client;
// 
// extern	edict_t		*sv_player;
extern client_t		*clients_ptr[MAX_CLIENTS];
...
TM_PURE
void DoCheckpoint(int point);	// GAJA: Checkpointing transactions
...
TM_CALLABLE
int SV_ModelIndex (char *name); // also defined in pr_cmds.c
...
//extern	enum redirect_e  sv_redirected;
//THREADPRIVATE(sv_redirected)
