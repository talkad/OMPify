...
void Netchan_Setup (netchan_t *chan, netadr_t adr, int qport)
{
	...
	chan->rate = 1.0/1000000; // GAJA: was 2500
}
...
{
  // GAJA: commented to avoid message pille up
  // Need to adjust this because of the realtime. After changes to SV_Frame realtime is not correct anymore.

//   printf("Thread: %d\tchan->cleartime = %f\t\trealtime = %f\n", omp_get_thread_num(), chan->cleartime, realtime);
...
*/
TM_CALLABLE
qboolean Netchan_Process (netchan_t *chan, int cl_number)
{
