...
def scan_repos(omp_repo):
    repo2pragmas = {}
    curr, num_users = 0, len(os.listdir(omp_repo))
    ...
    for user_name in os.listdir(omp_repo):
        ...
        curr += 1
        print(f'{curr}/{num_users}')
    
    with open("repo2pragmas_all.json", "w") as f:
...
# scan_json_per_year('/home/talkad/Downloads/thesis/data_gathering_script/visualization/repo2pragmas_all.json')
...
# all
# {2019: 1076, 2021: 1462, 2022: 1923, 2016: 364, 2020: 1260, 2018: 803, 2017: 693, 2014: 191, 2013: 84, 2015: 280}
# res = {2019: {2: 10834, 3: 1584, 4: 2388, 4.5: 336, 5: 141}, 2021: {2: 12762, 3: 1692, 4: 1235, 4.5: 107, 5: 86}, 2022: {2: 26169, 3: 4212, 4: 6001, 4.5: 771, 5: 324}, 2016: {2: 2315, 3: 187, 4: 59, 4.5: 0, 5: 1}, 2020: {2: 45268, 3: 6130, 4: 56961, 4.5: 13135, 5: 4783}, 2018: {2: 8252, 3: 946, 4: 271, 4.5: 66, 5: 47}, 2017: {2: 15696, 3: 1774, 4: 9236, 4.5: 2170, 5: 1138}, 2014: {2: 1433, 3: 185, 4: 2, 4.5: 0, 5: 0}, 2013: {2: 532, 3: 15, 4: 0, 4.5: 0, 5: 0}, 2015: {2: 5605, 3: 256, 4: 147, 4.5: 1, 5: 48}}
...
df = pd.DataFrame({'OpenMP 2.5':  [532, 1433, 5605, 2315, 15696, 8252, 10834, 45268, 12762, 26169],
                   'OpenMP 3':    [15, 185, 256, 187, 1774, 946, 1584, 6130, 1692, 4212],
                    'OpenMP 4':   [0, 2, 147, 59, 9236, 271, 2388, 56961, 1235, 6001], 
                    'OpenMP 4.5': [0, 0, 0, 0, 2170, 66, 336, 13135, 107, 771],
                    'OpenMP 5':   [0, 0, 0, 0, 1138, 1047, 141, 4783, 136, 324]}, index=list(range(2013, 2023))) 
